# RiddlesOfSphinx 1.0.0
#### made by Mojiboye Emmanuel

#### Sphinx asks a riddle to user
...
## Description
_How it works: the Sphinx asks a riddle and the user must answer the riddle correctly. If the riddle is answered correctly, the Sphinx asks a second riddle and so on._
